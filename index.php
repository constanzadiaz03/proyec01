        ...
        <section class="work contenedor" id="trabajo">
            ...
            <div class="botones-work">
                <ul>
                    ...
                    <li class="filter" data-nombre='mediciones'>Temperatura</li>
            ...
            <div class="galeria-work">
                <div class="cont-work mediciones">
                    <div class="img-work">
                        <img src="img/tabla1.png" alt="mediciones de temperatura">
                    </div>
                    <div class="textos-work">
                ...
                <div class="cont-work mediciones">
                    <div class="img-work">
                        <img src="img/tabla2.png" alt="temperaturas promedio">
                    </div>
                    <div class="textos-work">
                        <h4>Temperaturas promedio</h4>
                    </div>
                </div>
            </div>
        </section>
